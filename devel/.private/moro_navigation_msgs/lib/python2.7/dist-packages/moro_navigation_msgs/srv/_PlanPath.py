...
"""autogenerated by genpy from moro_navigation_msgs/PlanPathRequest.msg. Do not edit."""
import sys
...
class PlanPathRequest(genpy.Message):
  ...
  _type = "moro_navigation_msgs/PlanPathRequest"
...
def _get_struct_6d():
    ...
    return _struct_6d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from moro_navigation_msgs/PlanPathResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class PlanPathResponse(genpy.Message):
  ...
  _type = "moro_navigation_msgs/PlanPathResponse"
  _has_header = False #flag to mark the presence of a Header object
...
class PlanPath(object):
  _type          = 'moro_navigation_msgs/PlanPath'
  _md5sum = '098f7f8b063d412adcf0fd12d1459840'
